...
/************************mine*******************************/
/* ----------- LED's ---------- */
#define HAL_TURN_ON_LED_NWK()        GPIOPinWrite(BSP_LED_BASE, BSP_LED_1, BSP_LED_1)

#define HAL_TURN_OFF_LED_NWK()       GPIOPinWrite(BSP_LED_BASE, BSP_LED_1, 0)
...
/* ----------- Toggle the LEDs ---------- */
#define HAL_TOGGLE_LED_NWK()         GPIOPinWrite(BSP_LED_BASE, BSP_LED_1, ~(GPIOPinRead(BSP_LED_BASE, BSP_LED_1)))

/* ----------- Read the LEDs ---------- */
#define HAL_STATE_LED_NWK()          GPIOPinRead(BSP_LED_BASE, BSP_LED_1)
