...
{ 
  ...
  GPIOIntWakeupDisable(GPIO_IWE_PORT_A);//farhad
  GPIOIntWakeupEnable(GPIO_IWE_PORT_B);//farhad
  ...
  GPIOPowIntTypeSet(BSP_KEY_BASE, BSP_KEY_ALL,GPIO_POW_FALLING_EDGE);//farhad
  GPIOPowIntTypeSet(BSP_OCCSENSOR_BASE, BSP_OCCSENSOR, GPIO_POW_FALLING_EDGE);//farhad
...
{
  GPIOPowIntEnable(BSP_KEY_BASE, BSP_KEY_ALL);// farhad
  GPIOPowIntEnable(BSP_OCCSENSOR_BASE, BSP_OCCSENSOR); //farhad
}
...
{
  GPIOPowIntDisable(BSP_KEY_BASE, BSP_KEY_ALL);//farhad
  GPIOPowIntDisable(BSP_OCCSENSOR_BASE, BSP_OCCSENSOR); //farhad
}
...
{
  GPIOPowIntClear(BSP_KEY_BASE, BSP_KEY_ALL);//farhad
  GPIOPowIntClear(BSP_OCCSENSOR_BASE,BSP_OCCSENSOR);//farhad
}
